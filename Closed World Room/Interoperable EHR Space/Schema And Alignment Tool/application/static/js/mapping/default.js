...
var objOwlSuggestions = null;
 $(function() {
  ...
  $("#mapped-attributes li.mapped-attributes:has(li.mapped)")
    .each(
          function(){
  ...
  $("#raw-attributes li.raw-attributes:has(ol.attributes li.mapped)")
    .each(
          function(){
            $(this).removeClass("collapsed");
            $(this).children("a.expand-collapse-attributes")
   ...
   $("#button-save").click(function(event){
    ...
    $("#mapped-attributes").on( "click", "a.help",
                                function (event) {
                                   event.stopPropagation();
                                   return false;
                                }
    ...
    objSuggestions = new Suggestions('#dialog-add-mapping', {
                                                                ...
                                                                find: function( what ){
                                                                  ...
                                                                  $( "#raw-attributes .attributes li:not(.mapped):not(.disabled)")
                                                                          .filter( function(){
    ...
    objOwlSuggestions = new Suggestions('#dialog-map-raw-attribute', {
                                                                ...
                                                                find: function( what ){
                                                                  var search = what.toLowerCase();
                                                                  var newlis = new Array();
                                                                  $( "#mapped-attributes .attributes li:not(.disabled)")
                                                                          .filter( function(){
                                                                            return $(this).attr('display-name').toLowerCase().indexOf(search)>=0;
                                                                          })
                                                                          .each(function(i, e){
