/* 
   ReduceDataChiSquaredFeatureSelection.java - reduces dimensionality of a data cube using chi squared feature selection algorithm
...
public class ReduceDataChiSquaredFeatureSelection
{    
 public final static void main(String[]args) throws Exception
 {
    ...
    {
     System.err.println("Wrong number of input arguments.\nUsage: java ReduceDataChiSquaredFeatureSelection <categories meaning file name> <delete_missing_values (0 or 1)> <datacube_file_name> <class attribute index (optional)> <no of features> <weka_class_path> <reduced_data_cube_file_name> <tool xml description file>\n");
     System.exit(1);
    }
    ...
    cmd="java -Xmx1024m -cp "+weka_class_path+" weka.filters.supervised.attribute.AttributeSelection -E \" weka.attributeSelection.ChiSquaredAttributeEval\" -c \""+class_index+"\" -i \""+data_matrix_arff_file_name+"\" -S \"weka.attributeSelection.Ranker -T -1.7976931348623157E308 -N "+no_of_features+"\" >"+reduced_data_arff_file_name;
    ...
    try
    {
     ReduceDataRSFS.XMLdescription("Chi Squared Dimensionality Reduction",algorithm_params_setting,xml_desc_file_name);
    }
    catch(IOException e)
    {
     e.printStackTrace();
