...
java -Xmx1024m -cp DimensionalityReduction.jar ReduceDataChiSquaredFeatureSelection $2_varMeaning $1 $2 $3 $4 $5 $2_XML
VAL=$?
...
then
   echo "Exceptions are thrown by ReduceDataChiSquaredFeatureSelection.class"  
elif [ $VAL = '2' ]
then
