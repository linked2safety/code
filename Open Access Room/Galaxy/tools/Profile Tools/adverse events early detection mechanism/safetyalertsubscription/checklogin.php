...
//log into database using the postgresql username and password in db.php
...
else //user authentication successful
{
 //store userid, name and password into $_SESSION array and redirect to "login_success.php"
 session_start();
