...
function get_variables_and_values($host,$dbname,$user,$password)
{
 ...
 while ($row = pg_fetch_array($result, null, PGSQL_ASSOC)) 
 {
  ...
  $values_of_drug = $this -> get_variable_values($row2["values"],$missing_value);
 ...
 while ($row = pg_fetch_array($result, null, PGSQL_ASSOC)) 
 {
  ...
  $result2 = pg_query($query2) or die('Query failed: '.pg_last_error());
  $row2 = pg_fetch_array($result2, null, PGSQL_ASSOC);
  $values_of_MM = $this -> get_variable_values($row2["values"],$missing_value);
  $this -> MMs[$i] = $row["name"];
 ...
 while ($row = pg_fetch_array($result, null, PGSQL_ASSOC)) 
 {
  ...
  $result2 = pg_query($query2) or die('Query failed: '.pg_last_error());
  $row2 = pg_fetch_array($result2, null, PGSQL_ASSOC);
  $values_of_snp = $this -> get_variable_values($row2["values"],$missing_value);
 ...
 while ($row = pg_fetch_array($result, null, PGSQL_ASSOC)) 
 {
  ...
  $result2 = pg_query($query2) or die('Query failed: '.pg_last_error());
  $row2 = pg_fetch_array($result2, null, PGSQL_ASSOC);
  $values_of_ae = $this -> get_variable_values($row2["values"],$missing_value);
  $this -> AEs[$i] = $row["name"];
