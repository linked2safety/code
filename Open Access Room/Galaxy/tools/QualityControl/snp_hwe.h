...
*/
/*
 *   Copyright (C) 2014  -  Jan Wigginton  -  wiggie@umich.edu
 * 
 ...
 * 
 *   You may download the source code and associated license at http://www.sph.umich.edu/csg/abecasis/Exact/c_instruct.html
 * 
*/
