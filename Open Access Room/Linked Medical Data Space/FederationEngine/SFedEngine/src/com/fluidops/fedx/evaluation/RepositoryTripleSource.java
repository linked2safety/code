 ...
 *
 */
public class RepositoryTripleSource extends TripleSourceBase implements TripleSource{

	public static Logger log = Logger.getLogger(RepositoryTripleSource.class);
	 ...
	 * @param endpoint
	 */
	RepositoryTripleSource(Endpoint endpoint) {
