...
import org.deri.linked2safety.sfedengine.optimizer.SFedEngineSourceSelection;
import org.deri.linked2safety.sfedengine.optimizer.SFedEngineSourceSelectionIndexed;
...
//		sourceSelection.doSourceSelection(info.getStatements());
		...
		// Source selection through access policies
		 SFedEngineSourceSelection sourceSelection = new SFedEngineSourceSelection(members, cache, queryInfo);
		 sourceSelection.doSourceSelection(info.getStatements());
		 
		 //Source selection through data structure definition
//		 SFedEngineSourceSelectionIndexed sourceSelection = new SFedEngineSourceSelectionIndexed(members, cache, queryInfo);
//		 sourceSelection.doSourceSelection(info.getStatements());
