...
public class Endpoint  {
	...
	protected static Logger log = Logger.getLogger(Endpoint.class);
	...
	// the type, e.g. SPARQL, NativeRepo
	protected EndpointType type = null;
	// the endpoint classification
	protected EndpointClassification endpointClassification;
		
	protected Repository repo;
	// a Singleton RepositoryConnection for the given endpoint
	protected RepositoryConnection conn  = null;
	// true, iff the contained repository is initialized
	protected boolean initialized = false;
	// the triple source, initialized when repository is set
	...
	public RepositoryConnection repairConnection() throws RepositoryException {
		...
		if (conn!=null) {
			try {
				...
				log.warn("Connection of endpoint " + id + " could not be closed: " + e.getMessage(), e);
			}
		}
		conn = repo.getConnection();
