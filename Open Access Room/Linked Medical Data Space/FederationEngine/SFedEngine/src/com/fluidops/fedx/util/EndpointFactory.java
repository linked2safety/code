...
public class EndpointFactory {
	...
	public static List<Endpoint> loadFederationMembers(File dataConfig) throws FedXException {
		...
		try {
			...
			log.error("Unable to parse dataconfig " + dataConfig + ":", e);
	...
	public static Endpoint loadEndpoint(Graph graph, Resource repNode, Value repType) throws FedXException {
		...
		// if: NativeStore => Sesame native store implementation
		// else if 1: SPARQL Repository => SPARQLRepository
		// else if 2: Remote Repository
		// else if 3: other generic type
